...
using EventProcessHTTP.Model.EventProcessHTTP.Model;
...
namespace EventProcessHTTP
{
    public class EventProcess
    {
            ...
            ILogger log)
        {
            ...
            string instanceId = "websub-" + data.SesstionId.ToString();

            DurableOrchestrationStatus instance = await starter.GetStatusAsync(instanceId);
            ...
            {
                instanceId = await starter.StartNewAsync("OrchestratorFunction", instanceId, data);
